...
$sql=" SELECT a.id,a.nama_guru,a.nip,a.active,a.no_telphone,b.id_users,b.id_level,c.id_level,c.nama_level,a.status_guru,b.KodeLogin ";
$sql.=" FROM tb_guru as a left join tb_users as b on b.id_users=a.id left join tb_level as c on c.id_level=b.id_level ";
$query 	 		= mysqli_query($conn, $sql) or die();
$totalData 		= mysqli_num_rows($query);
$totalFiltered 	= $totalData; 

if(!empty($requestData['search']['value']) ) {  
	$sql=" SELECT a.id,a.nama_guru,a.nip,a.active,a.no_telphone,b.id_users,b.id_level,c.id_level,c.nama_level,a.status_guru,c.KodeLogin ";
	$sql.=" FROM tb_guru as a left join tb_users as b on b.id_users=a.id left join tb_level as c on c.id_level=b.id_level ";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = test_input($row["nama_level"]);
